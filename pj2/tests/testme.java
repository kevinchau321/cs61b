...
public class testme {
	...
	public static void main(String[] args) {
		...
		*/
		...
		gb13.addChip(new Chip(0,5,5));
		gb13.addChip(new Chip(0,1,6));
		gb13.addChip(new Chip(0,2,6));
		
		gb13.addChip(new Chip(1,6,1));
		gb13.addChip(new Chip(1,0,2));
		gb13.addChip(new Chip(1,3,2));
		gb13.addChip(new Chip(1,1,3));
		gb13.addChip(new Chip(1,0,5));
		gb13.addChip(new Chip(1,3,5));
		gb13.addChip(new Chip(1,6,5));
		MachinePlayer mp13 = new MachinePlayer(1);
		mp13.setGame(gb13);
        System.out.println(gb13.toString());
        System.out.println(mp13.chooseMove());
        System.out.println(gb13.toString());
	}   
}
