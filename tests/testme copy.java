...
public class testme {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("There is a valid white network: " + gameBoard.hasValidNetwork(1));
		...
		*/
		...
		// System.out.println("Testing first moves for black");
		// MachinePlayer p9 = new MachinePlayer(0);
		// GameBoard gb9 = p9.getGame();
		// System.out.println(gb9.toString());
		// System.out.println("first ChooseMove():"+p9.chooseMove());
		// System.out.println(gb9.toString());
		// System.out.println("second ChooseMove():"+p9.chooseMove());
		// System.out.println(gb9.toString());

		// System.out.println("Testing first moves for white");
		// MachinePlayer p10 = new MachinePlayer(1);
		// GameBoard gb10 = p10.getGame();
		// System.out.println(gb10.toString());
		// System.out.println("first ChooseMove():"+p10.chooseMove());
		// System.out.println(gb10.toString());
		// System.out.println("second ChooseMove():"+p10.chooseMove());
		// System.out.println(gb10.toString());
		/*
		...
		*/
		...
		//testing choose move, should choose a step move
		...
		//	allens test for eval
		// GameBoard gb8 = new GameBoard();	//white has network

		// gb8.addChip(new Chip(1,4,6));
		// gb8.addChip(new Chip(1,5,6));
		// gb8.addChip(new Chip(1,7,3));

		// gb8.addChip(new Chip(0,1,0));
		// gb8.addChip(new Chip(0,3,0));
		// gb8.addChip(new Chip(0,1,3));
		// gb8.addChip(new Chip(0,3,3));
		// gb8.addChip(new Chip(0,3,7));
		// gb8.addChip(new Chip(0,5,2));
		// gb8.addChip(new Chip(0,6,1));
		// System.out.println(gb8.toString());
		// System.out.println("White has valid network: (true) " + gb8.hasValidNetwork(1));
		// System.out.println("Board's chip list: " + gb8.getChipList());

		// MachinePlayer mp8 = new MachinePlayer(0);
		// mp8.setGame(gb8);

		// System.out.println("Evaluation score is: " + mp8.evaluation(mp8.getGame()));
		// System.out.println("Evaluation score is: " + mp8.evaluation(mp8.getGame()));
		// System.out.println("Eval score should be: -1");
		// System.out.println("There is a valid white network: " + gb8.hasValidNetwork(1));
		// System.out.println("There is a valid white network should be: true");

		// //checking hash dict test
		// GameBoard gb11 = new GameBoard();
		// gb11.addChip(new Chip(1,0,2));
		// MachinePlayer mp11 = new MachinePlayer(0);
		// mp11.setGame(gb11);
		// System.out.println("Evaling 1st time: " + mp11.eval(gb11));
		// System.out.println("Evaling checking dictionary:" + mp11.eval(gb11));




		// // test for choosing winning move
		// GameBoard gb12 = new GameBoard();
		// gb12.addChip(new Chip(0,1,1));
		// gb12.addChip(new Chip(0,2,1));
		// gb12.addChip(new Chip(0,4,1));
		// gb12.addChip(new Chip(0,5,1));
		// gb12.addChip(new Chip(0,1,6));

		// gb12.addChip(new Chip(1,0,2));
		// gb12.addChip(new Chip(1,1,2));
		// gb12.addChip(new Chip(1,4,2));
		// gb12.addChip(new Chip(1,1,5));
		// gb12.addChip(new Chip(1,4,5));

		// MachinePlayer mp12 = new MachinePlayer(1);
		// mp12.setGame(gb12);
		
		// System.out.println(gb12.toString());
		// System.out.println("Black count is: " + gb12.getCount(0));
		// System.out.println("White count is: " + gb12.getCount(1));
		// System.out.println("Eval before choosemove: " + mp12.evaluation(gb12));



		// System.out.println("We chose move: " + mp12.chooseMove().toString());
		// System.out.println("We want move: a winning move");
		// System.out.println(gb12.hasValidNetwork(1));
		// System.out.println(gb12.toString());
		// System.out.println("Eval after choosemove: " + mp12.evaluation(gb12));





		//test choose move on simple board for add moves
		GameBoard gb13 = new GameBoard();
		gb13.addChip(new Chip(0,1,1));
		gb13.addChip(new Chip(0,2,1));
		gb13.addChip(new Chip(0,4,1));
		gb13.addChip(new Chip(0,5,1));
		gb13.addChip(new Chip(0,1,6));

		gb13.addChip(new Chip(1,0,2));
		gb13.addChip(new Chip(1,1,5));
		gb13.addChip(new Chip(1,3,6));
		gb13.addChip(new Chip(1,4,4));

		MachinePlayer mp13 = new MachinePlayer(1);
		mp13.setGame(gb13);
		System.out.println("We chose move: " + mp13.chooseMove().toString());
			
		//Chance to win test5
		GameBoard gb14 = new GameBoard();
		gb14.addChip(new Chip(0,1,1));
		gb14.addChip(new Chip(0,2,1));
		gb14.addChip(new Chip(0,4,1));
		gb14.addChip(new Chip(0,5,1));
		gb14.addChip(new Chip(0,5,5));
		gb14.addChip(new Chip(0,1,6));
		gb14.addChip(new Chip(0,2,6));
		
		gb14.addChip(new Chip(1,6,1));
		gb14.addChip(new Chip(1,0,2));
		gb14.addChip(new Chip(1,3,2));
		gb14.addChip(new Chip(1,1,3));
		gb14.addChip(new Chip(1,0,5));
		gb14.addChip(new Chip(1,3,5));
		gb14.addChip(new Chip(1,6,5));
		MachinePlayer mp14 = new MachinePlayer(1);
		mp14.setGame(gb14);
        System.out.println(gb14.toString());
        System.out.println(mp14.chooseMove());
        System.out.println(gb14.toString());
