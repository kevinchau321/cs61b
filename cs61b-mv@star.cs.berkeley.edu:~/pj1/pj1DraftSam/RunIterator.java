...
public class RunIterator implements Iterator {
  ...
  public boolean hasNext() {
    ...
    if (currentRun.next.next == null) {     //true when next is tail.
      return false;
    } else {
      return true;
    }
  ...
  public int[] next() {
    ...
    if (hasNext()==true) {
      ...
      runArray[0] = currentRun.length;
      runArray[1] = currentRun.red;
      runArray[2] = currentRun.green;
      runArray[3] = currentRun.blue;
