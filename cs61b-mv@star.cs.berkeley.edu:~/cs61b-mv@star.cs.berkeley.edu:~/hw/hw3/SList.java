...
public class SList {
  ...
  private int size; ///change to public to enable homework3.main debugging
  ...
  public void squish() {
    ...
    while (currentNode.next != null) {
      if (currentNode.item.equals(currentNode.next.item)) {
          SListNode removedNode = currentNode.next;
          currentNode.next = currentNode.next.next;
          removedNode.next = null;
          this.size--;
      }
      if (currentNode.next!=null&&currentNode.next.item.equals(currentNode.item)==false){
          currentNode = currentNode.next;
      }
    }
  }
