...
public class Homework3 {
  ...
  public static void main(String[] args) {
    ...
    int[] test10 = {0, -1, -1, -1, 0, 0, 0};
    System.out.println("smooshing " + stringInts(test10) + ":");
    smoosh(test10);
    result = stringInts(test10);
    System.out.println(result);
    TestHelper.verify(result.equals("[  0  -1  0  -1  -1  -1  -1  ]"),
                      "BAD SMOOSH!!!  No cookie.");
    int[] test11 = {0};
    System.out.println("smooshing " + stringInts(test11) + ":");
    smoosh(test11);
    result = stringInts(test11);
    System.out.println(result);
    TestHelper.verify(result.equals("[  0  ]"),
                      "BAD SMOOSH!!!  No cookie.");
     int[] test12 = {};
    System.out.println("smooshing " + stringInts(test12) + ":");
    smoosh(test12);
    result = stringInts(test12);
    System.out.println(result);
    TestHelper.verify(result.equals("[  ]"),
                      "BAD SMOOSH!!!  No cookie.");
    ...
    System.out.println(result);
    //System.out.println("size is now "+list5.size);
    ...
    System.out.println(result);
    //System.out.println("size is now "+list6.size);
    ...
    System.out.println(result);
    //System.out.println("size is now "+list7.size);
    ...
    System.out.println(result);
    //System.out.println("size is now "+list8.size);
    TestHelper.verify(result.equals("[  0  1  2  3  4  5  6  ]"),
                      "BAD SQUISH!!!  No biscuit.");
