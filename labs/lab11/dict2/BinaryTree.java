...
public class BinaryTree implements Dictionary {
  ...
  public Entry remove(Object key) {
    BinaryTreeNode removedNode = findHelper((Comparable) key, root); 
    if (removedNode == null) { 
      return null; 
    } else { 
        this.size--; 
        ...
        if (removedNode.leftChild == null && removedNode.rightChild == null) { 
          ...
          return removedNode.entry;  
            ...
            BinaryTreeNode right = removedNode.rightChild; 
            ...
            if (replaceNode == null) { 
                replaceNode = removedNode.rightChild; 
                if (removedNode == this.root) { 
                  this.root = replaceNode; 
                  replaceNode.leftChild = removedNode.leftChild; 
                  replaceNode.leftChild.parent = replaceNode; 
                  replaceNode.rightChild = removedNode.rightChild; 
                  replaceNode.rightChild.parent = replaceNode; 
                  this.root = replaceNode; 
                  replaceNode.parent = null; 
                } else { 
                    if (removedNode.leftChild == replaceNode) { 
                      removedNode.parent.leftChild = replaceNode; 
                    } else { 
                        removedNode.parent.rightChild = replaceNode; 
                    }
                    replaceNode.parent = removedNode.parent; 
                    replaceNode.leftChild = removedNode.leftChild; 
                    removedNode.leftChild.parent = replaceNode; 
            ...
            if (removedNode == this.root) { 
              this.root = removedNode.leftChild; 
              removedNode.leftChild.parent = null; 
              return removedNode.entry; 
            }
            ...
            removedNode.leftChild = null; 
            return removedNode.entry;
        } else if (removedNode.rightChild != null && removedNode.leftChild == null) { 
            if (removedNode == this.root) { 
              this.root = removedNode.rightChild; 
              removedNode.rightChild.parent = null; 
              return removedNode.entry; 
            }
